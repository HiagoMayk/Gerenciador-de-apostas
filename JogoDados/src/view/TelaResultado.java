...
public class TelaResultado extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Insira o objeto ganhador: ");
    ...
    private void cbObjetosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cbObjetosActionPerformed
        ...
        if(id > -1){
            ...
            IGerenciadorResultado gerenciadorResultado = new GerenciadorResultadoDados();
            ...
            if(gerenciadorResultado.getResultado() == null){
              ...
              IRegraJogo regraJDados = new RegraJogoDados();
              regraJDados.calcularTabelaPremiacao(gerenciadorApostador.getDAOApostadores());
              String temp = String.valueOf(regraJDados.premioPorApostador(gerenciadorResultado.getResultado()).get(0).getPremio());

              textoGanhador.setText("Ganhador: \n " + gerenciadorResultado.getResultado().getClassificacao().get(0).getNome() + " --- " + temp);
            }
        }     
