...
public class RemoverAposta extends javax.swing.JFrame {
    ...
    private void cbApostadoresActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cbApostadoresActionPerformed
        ...
        if (indexApostador > -1){
            for (int i = 0; i < gerenciadorapostador.getApostador(indexApostador).getDAOAposta().getApostas().size() ; i++)
            {
                cbApostas.addItem(gerenciadorapostador.getApostador(indexApostador).getDAOAposta().getApostas().get(i).getObjetosAposta().get(0).getNome()+"--" + gerenciadorapostador.getApostador(indexApostador).getDAOAposta().getApostas().get(i).getValor());                
            }
        }
